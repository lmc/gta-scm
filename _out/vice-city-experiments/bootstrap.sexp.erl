...
(create_player ((int8 0) (float32 80.0) (float32 -849.7999877929688) (float32 9.300000190734863) (dmavar 8)))
...
(set_player_control ((dmavar 8) (int8 1)))
% 00000251 - b7 01
(release_weather)
