...
% set whenever the external script needs to pop it's current route node and push new ones
(set_var_int   ((var checkpoint_test_pop_route) (int32 0)))

% set whenever the in-game checkpoints need to be regenerated
