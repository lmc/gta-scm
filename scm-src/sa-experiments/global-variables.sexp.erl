...
% (UseGlobalVariables mission_4_vars 21700 22260)
(UseGlobalVariables persist 21700 22268)
...
(UseGlobalVariables temp 55976 60026)

% (UseGlobalVariablesDefault persist)

% (UseGlobalVariablesPool my_gvar temp)
